...
<h3>Проект по автоматизации тестирования API для сайта </h3>[Reqres](https://reqres.in)
...
<h3>Проект по автоматизации тестирования мобильного приложения</h3>[Wikipedia](https://ru.wikipedia.org/)
